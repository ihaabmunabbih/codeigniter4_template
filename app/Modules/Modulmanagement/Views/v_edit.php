...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="content py-3" style="font-size: 0.8rem !important; font-weight: 600;">
            <form id="editMenu" action="<?php echo base_url('managementmodul/do_edit'); ?>" method="post">
                ...
                <div class="input-group form-row mb-1">
                    <div class="mb-2 col-md-5 col-10 mx-auto">
                        ...
                        <input type="hidden" name="id_parent_old" id="id_parent_old">
                    </div>
                    <div class="mb-2 col-md-5 col-10 mx-auto">
