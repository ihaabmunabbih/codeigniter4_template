<div class="panel">
    ...
    <div class="panel-body">
        <div class="content py-3" style="font-size: 0.8rem !important; font-weight: 600">
            <form id="editGroup" action="<?php echo base_url('groupmanagement/do_edit'); ?>" method="post">
                <div class="mb-2 col-12 col-md-6 mx-auto">
                    <label for="group_id" class="form-label">ID Group</label>
                    <input type="text" class="form-control" name="group_id" id="group_id" placeholder="ID Group" required value="<?= $data->user_group ?>">
                    <input type="hidden" name="id" id="id" value="<?= $data->id ?>">
                </div>
                <div class="mb-2 col-12 col-md-6 mx-auto">
                    <label for="name" class="form-label">Nama Group</label>
                    <input type="text" class="form-control" name="name" id="name" placeholder="Nama Group" required value="<?= $data->group_name ?>">
                </div>
                <div class="mb-2 col-12 col-md-6 mx-auto">
                    <label for="description" class="form-label">Deskripsi</label>
                    <input type="text" class="form-control" name="description" id="description" placeholder="Deskripsi" value="<?= $data->deskripsi ?>">
                </div>
