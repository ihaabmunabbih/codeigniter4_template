<div class="panel">
    ...
    <div class="panel-body">
        <div class="content py-3" style="font-size: 0.8rem !important; font-weight: 600">
            <form id="editGroup" action="<?php echo base_url('aksimodul/do_edit'); ?>" method="post">
                <div class="mb-2 col-12 col-md-6 mx-auto">
                    <label for="nama_aksi" class="form-label">Nama Aksi</label>
                    <input type="text" class="form-control" name="nama_aksi" id="nama_aksi" placeholder="Nama Aksi" required value="<?= $data->nama_aksi ?>">
